package com.spring.recipegradle.bootstrap;

import com.spring.recipegradle.domain.*;
import com.spring.recipegradle.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void loadUom() {
        ...
        if (cupsUnitOfMeasureOptional.isEmpty()) {
    ...
    private List<Recipe> getRecipes() {
        Optional<Recipe> perfectGuacamole = recipeRepository.findByDescription("Perfect Guacamole");
        Optional<Recipe> spicyGrilledChickenTaco = recipeRepository.findByDescription("Spicy Grilled Chicken Taco");

        if (perfectGuacamole.isEmpty() && spicyGrilledChickenTaco.isEmpty()) {
